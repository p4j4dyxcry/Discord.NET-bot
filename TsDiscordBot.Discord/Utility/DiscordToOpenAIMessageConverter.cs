...
namespace TsDiscordBot.Discord.Utility
{
    ...
    public static class DiscordToOpenAIMessageConverter
    {
        ...
        public static ConvertedMessage ConvertFromDiscord(IMessageData message)
        {
            // 表示名
            ...
            return new ConvertedMessage(body, author, when, message.FromTsumugi, false, attachments);
        }
